...
func TestUpsertRunsAndListRunKeys(t *testing.T) {
	...
	err = store.UpsertRuns(ctx, []contracts.RunRecord{
		{Environment: "dev", RunURL: " https://run-b ", JobName: "job-b", OccurredAt: "2026-03-05T10:00:00Z"},
		{Environment: "dev", RunURL: "https://run-a", JobName: "job-a", OccurredAt: "2026-03-05T09:00:00Z"},
		{Environment: "int", RunURL: "https://run-a", JobName: "job-a-int", OccurredAt: "2026-03-05T08:00:00Z"},
	})
	if err != nil {
	...
	err = store.UpsertRuns(ctx, []contracts.RunRecord{
		{Environment: "dev", RunURL: "https://run-a", JobName: "job-a-updated", OccurredAt: "2026-03-05T11:00:00Z"},
	})
	if err != nil {
...
func TestUpsertRawFailuresAndListRunKeys(t *testing.T) {
	...
	err = store.UpsertRawFailures(ctx, []contracts.RawFailureRecord{
		{Environment: "dev", RowID: "row-2", RunURL: "https://run-b", SignatureID: "sig-b", OccurredAt: "2026-03-05T10:00:00Z", RawText: "raw-b", NormalizedText: "norm-b"},
		{Environment: "dev", RowID: "row-1", RunURL: "https://run-a", SignatureID: "sig-a", OccurredAt: "2026-03-05T09:00:00Z", RawText: "raw-a", NormalizedText: "norm-a"},
		{Environment: "int", RowID: "row-1", RunURL: "https://run-a", SignatureID: "sig-a-int", OccurredAt: "2026-03-05T07:00:00Z", RawText: "raw-a-int", NormalizedText: "norm-a-int"},
	})
	if err != nil {
	...
	err = store.UpsertRawFailures(ctx, []contracts.RawFailureRecord{
		{Environment: "dev", RowID: "row-1", RunURL: "https://run-a", SignatureID: "sig-a", OccurredAt: "2026-03-05T11:00:00Z", RawText: "raw-a-updated", NormalizedText: "norm-a-updated"},
	})
	if err != nil {
