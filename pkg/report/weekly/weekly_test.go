...
func TestGenerateWritesWeeklyReportForAllEnvironments(t *testing.T) {
	...
	requiredSnippets := []string{
		...
		"88.89% (8/9)",
		"Up to 50 failures are loaded in this window (minimum 1.00% impact), with 10 shown by default. Default sorting is impact desc, jobs affected desc, flake score desc; click headers to re-sort.",
